    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={
              "rounded-lg h-24 bg-dark9 ml-4 mr-4 mt-12 mb-2 flex justify-center items-center"
            }
          >
            <h4 className={"text-light text-center text-sm p-12"}>
              By connecting a wallet, you agree to DockerizeIT’s{" "}
              <span className={"text-accent underline"}>Terms of Service.</span>
            </h4>
          </div>
          <div
            className={
              "rounded-lg h-16 bg-dark7 ml-4 mr-4 mt-2 mb-2 flex justify-start items-center"
            }
          >
          ...
          <div
            className={
              "rounded-lg h-32 bg-dark9 ml-4 mr-4 mt-2 mb-2 flex justify-start items-center"
            }
          >
            <p className={"font-semibold text-2xl ml-8"}>MetaMask</p>
            <p className={"font-normal text-lg ml-8"}>
